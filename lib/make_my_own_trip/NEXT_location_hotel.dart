...
import 'package:myot_app/make_my_own_trip/next_location_transport.dart';
...
class Next_location_hotel extends StatelessWidget {
  const Next_location_hotel({Key? key}) : super(key: key);
